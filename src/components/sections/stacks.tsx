          ...
          <div className="flex items-center p-2 sm:p-3 md:p-4 xl:p-4  border border-zinc-300 rounded-lg dark:border-zinc-800">
            <div className="ml-4 flex-grow  pb-8">
              ...
              <div className="mt-4 grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4"> 
                <Card src="./public/assets/img/html.png" ringColorClass="ring-orange-700" className='card'>
                  <AlertTitle className='mb-2 font-normal text-sm'>HTML</AlertTitle>
                </Card>
                <Card src="./public/assets/img/css.png" ringColorClass="ring-blue-500" className='card'>
                ...
                <Card src="./public/assets/img/react.png" ringColorClass="ring-blue-400" className='card'>
                ...
                <Card src="./public/assets/img/vite.png" ringColorClass="ring-purple-400" className='card'>
                ...
                <Card src="./public/assets/img/bootstrap.png" ringColorClass="ring-purple-600" className='card'>
              ...
              <div className="mt-4 grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4"> 
                <Card src="./public/assets/img/express.png" ringColorClass="ring-zinc-500" className='card'>
                  <AlertTitle className='mb-2 font-normal text-sm'>Express</AlertTitle>
                </Card>
                <Card src="./public/assets/img/node.png" ringColorClass="ring-emerald-500" className='card'>
                  <AlertTitle className='mb-2 font-normal text-sm'>Node Js</AlertTitle>
                </Card>
                <Card src="./public/assets/img/python.png" ringColorClass="ring-yellow-500" className='card'>
                  <AlertTitle className='mb-2 font-normal text-sm'>Python</AlertTitle>
                </Card>
                <Card src="./public/assets/img/java.png" ringColorClass="ring-blue-400" className='card'>
              ...
              <div className="mt-4 grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4"> 
                <Card src="./public/assets/img/figma.png" ringColorClass="ring-zinc-400" className='card'>
              ...
              <div className="mt-4 grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4"> 
                <Card src="./public/assets/img/docsauros.png" ringColorClass="ring-emerald-500" className='card'>
              ...
              <div className="mt-4 grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4"> 
                ...
                <Card src="./public/assets/img/azure.png" ringColorClass="ring-zinc-500" className='card'>
